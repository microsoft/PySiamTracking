...
work_dir = './output/spm/spm_r50c4_dw/'
log_level = 'INFO'
resume_from = None
...
model = dict(
    ...
    cm_head=dict(
        ...
        pre_convs=dict(num_layers=2, in_channels=256, out_channels=256, kernel_size=3, padding=0, nonlinear_last=True),
        head_convs=[
            dict(num_layers=1, in_channels=256, out_channels=10, kernel_size=1, nonlinear_last=False),
            dict(num_layers=1, in_channels=256, out_channels=20, kernel_size=1, nonlinear_last=False),
        ],
    ...
    fm_fusion=dict(
        ...
        stride=[8, 8],
        out_size=6,
        post_convs=dict(num_layers=1, in_channels=(512 + 1024) * 2, out_channels=256, kernel_size=1,
                        nonlinear_last=True),
        fuse_type='concat',
    ),
    fm_head=dict(
