...
from .hooks import (Hook, LrUpdaterHook, CheckpointHook, IterTimerHook, NumpySeedHook, ChangeStatusHook,
...
class Runner(object):
    """A training helper for PyTorch. (from mmcv library)
    ...
    def init_optimizer(self, optimizer):
        ...
        Args:
            optimizer (dict): a dict used for constructing the optimizer.
        ...
        _opt = getattr(torch.optim, optimizer_type)(params=self.model.parameters(), **args)
    ...
    def init_logger(self, log_dir, level=logging.INFO):
        """Init the logger.
    ...
    def run(self, data_loader, workflow, max_epochs, **kwargs):
        """Start running.

        Args:
            data_loader (:obj:`DataLoader`): Dataloader for training
    ...
    def register_status_hook(self, action_config):

        self.register_hook(ChangeStatusHook(action_config), 'LOWEST')
    ...
    def register_logger_hooks(self, log_config):
        ...
        for info in log_config['hooks']:
            ...
            logger_hook = getattr(hooks, obj_type)(interval=log_interval, **args)
    ...
    def register_training_hooks(self,
        ...
        self.register_hook(self.build_hook(checkpoint_config, CheckpointHook), priority='HIGHEST')
